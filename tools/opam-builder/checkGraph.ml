...
let analyze st c =
  ...
  let stats = Array.mapi (fun i stats_switch ->
    let stats = ref [] in
  ...
  stats
    ...
    (* 3453 - 2286 = 1200 versions need to be installable *)
